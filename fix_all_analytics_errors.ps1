...
"@
    ...
    # Fix 11: Fix viewit.bio link
    $content = $content -replace "luxe\.bio/$profileName", "viewit.bio/$profileName"
...
Write-Host "11. viewit.bio link references" -ForegroundColor White
