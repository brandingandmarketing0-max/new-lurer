...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 121, 111, 117, 114, 98, 108, 117, 101, 101, 121, 101, 100, 98, 97, 98, 121];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("bFrQ1ld8h0ZP2raQ4MyJrOnvTS3wt59Z8RaEbUY1LgmVojDW");
        img.alt = "Abby";
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track Abby analytics:", error);
      }
    };
