...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 115, 104, 101, 108, 108, 121, 104, 117, 110, 116, 101, 114, 120, 111];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("XQC8QM7wDFrtXzqG5R7wDFrtu6IWL8KB4GHJCO0zo5MEAV1P");
        img.alt = "shellyhunterxo";
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track ShellyHunterXO analytics:", error);
      }
    };
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <div className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg rounded-full overflow-hidden bg-[#B6997B]/20">
                    ...
                    >
                      <span className="text-[#8B7355] text-2xl font-bold">S</span>
                    </div>
                  </div>
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src={imagesLoaded ? getObfuscatedImageUrl("XQC8QM7wDFrtCFkfmKDMiUGLYEr2Qy3FTdzPX8w7VWhcsa6N") : ""}
