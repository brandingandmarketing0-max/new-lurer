...
import { Lock, Heart, Star, Crown, Sparkles, AlertTriangle, X } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const handleConfirmAge = () => {
    ...
    window.open("https://onlyfans.com/bb18xo", "_blank", "noopener,noreferrer");
  };
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtzUgkLR9qCSay35uLTDJ0d4jn8xMZUczPtBrR" alt="Brookex" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg cursor-pointer hover:shadow-xl transition-shadow duration-300 backdrop-blur-sm">
              <CardContent className="p-0">
                <div className="relative group">
                  <Image
                    src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtSw1ORw2CJrnQmTUKN4XfF89iAuaSsv7pM6jG"
