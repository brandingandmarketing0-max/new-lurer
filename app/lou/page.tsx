    ...
    const send = () => {
      try {
        ...
        if (navigator.sendBeacon) {
          ...
          navigator.sendBeacon('/api/lou-analytics', blob);
        } else {
          fetch("/api/lou-analytics", {
            method: "POST",
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="/images/lou1.png" alt="Summermae" className="object-cover" />
