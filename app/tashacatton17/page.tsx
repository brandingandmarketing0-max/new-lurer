...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 116, 97, 115, 104, 97, 99, 97, 116, 116, 111, 110, 49, 55];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("XQC8QM7wDFrt6vZqPRnbAVMlHRWpPwDv1kTzN2nUg0mSyaJL");
        img.alt = "tashacatton17";
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track TashaCatton17 analytics:", error);
      }
    };
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src={imagesLoaded ? getObfuscatedImageUrl("XQC8QM7wDFrtjdLItBkO6cE1Hx9hnkSpGgRPFd5X2VAWluLD") : ""}
