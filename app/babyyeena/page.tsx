...
export default function ProfilePage() {
    ...
    const send = () => {
      try {
        ...
        if (navigator.sendBeacon) {
          ...
          navigator.sendBeacon('/api/babyyeena-analytics', blob);
        } else {
          fetch("/api/babyyeena-analytics", {
            method: "POST",
  ...
  const trackClick = async (clickType: string) => {
    try {
      await fetch("/api/babyyeena-analytics", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          page: "babyyeena",
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="/images/baby1.png" alt="Summermae" className="object-cover" />
