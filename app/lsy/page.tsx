...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const sessionId = `lsy_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
    const sessionKey = `lsy_visit_tracked_${sessionId}`;
    ...
    const send = () => {
      try {
        ...
        if (navigator.sendBeacon) {
          ...
          console.log("✅ LSY Analytics - Page visit tracked via sendBeacon");
          
          // Mark this specific session as tracked
          localStorage.setItem(sessionKey, 'true');
          localStorage.setItem('lsy_last_tracked', new Date().toISOString());
          setHasTracked(true);
        } else {
          fetch("/api/track", {
            method: "POST",
            ...
            console.log("✅ LSY Analytics - Page visit tracked via fetch");
            ...
            console.error("❌ LSY Analytics - Page visit tracking failed:", error);
          });
        }
      } catch (error) {
        console.error("❌ Failed to track LSY analytics:", error);
      }
    };
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtfvghmErFEYHRmqn7SKJGctzVyX9N8iI0r1TZ" alt="LSY" className="object-cover" />
