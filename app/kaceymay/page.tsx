...
export default function ProfilePage() {
    ...
    const send = () => {
      try {
        ...
        if (navigator.sendBeacon) {
          ...
          navigator.sendBeacon('/api/kaceymay-analytics', blob);
        } else {
          fetch("/api/kaceymay-analytics", {
            method: "POST",
        ...
        console.error("Failed to track Kaceymay analytics:", error);
      }
    };
  ...
  const trackClick = async (clickType: string) => {
    try {
      await fetch("/api/kaceymay-analytics", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          page: "kaceymay",
      ...
      <div className="flex min-h-screen items-center justify-center px-2">
        <div className="w-full max-w-md mx-auto">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="/images/kacey1.png" alt="Summermae" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Link href="https://onlyfans.com/kaceymayox" target="_blank" rel="noopener noreferrer">
