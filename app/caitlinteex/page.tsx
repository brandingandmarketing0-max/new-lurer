...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 99, 97, 105, 116, 108, 105, 110, 116, 101, 101, 120];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("XQC8QM7wDFrtygPt5hFPDmewkJSI6loX7cpzfs3VgdjyuBUK");
        img.alt = "Caitlinteex";
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track Caitlinteex analytics:", error);
      }
    };
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src={imagesLoaded ? getObfuscatedImageUrl("XQC8QM7wDFrtSj0x8w2CJrnQmTUKN4XfF89iAuaSsv7pM6jG") : ""}
