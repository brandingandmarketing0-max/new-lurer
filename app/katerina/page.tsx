...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 107, 52, 116, 101, 114, 105, 110, 97, 120];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("XQC8QM7wDFrt5Q6dHnVTon8G5vFmEWJsKazYk0O2fCwj3HBl");
        img.alt = "Katerina";
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track Katerina analytics:", error);
      }
    };
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src={imagesLoaded ? getObfuscatedImageUrl("XQC8QM7wDFrtbSZgkRGw5PsTJ23NUOtXn7myKL9CSZ6l0aru") : ""}
