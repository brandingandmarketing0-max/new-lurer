...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track Kayley analytics:", error);
      }
    };
  ...
  const handleConfirmAge = () => {
    ...
    const targetUrl = (() => {
      const chars = [104,116,116,112,115,58,47,47,111,110,108,121,102,97,110,115,46,99,111,109,47,107,97,121,108,111,117,105,115,101,120];
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtFkAdqpcf5QeZo76jBcMzg2DEVPJRlL80I1qm" alt="Summermae" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-0">
                <div className="relative group">
                  <Image
                    src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtVSBsobzUkvrqpFG0ygHEzfL2ncJhAetV4R3T"
