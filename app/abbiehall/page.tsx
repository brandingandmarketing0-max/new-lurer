...
export default function ProfilePage() {
    ...
    const send = () => {
      try {
        ...
        if (navigator.sendBeacon) {
          ...
          navigator.sendBeacon('/api/abbiehall-analytics', blob);
        } else {
          fetch("/api/abbiehall-analytics", {
            method: "POST",
  ...
  const trackClick = async (clickType: string) => {
    try {
      await fetch("/api/abbiehall-analytics", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          page: "abbiehall",
      ...
      <div className="flex min-h-screen items-center justify-center px-2">
        <div className="w-full max-w-md mx-auto">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="/images/abby1.png" alt="Summermae" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Link href="https://onlyfans.com/abbeyemx" target="_blank" rel="noopener noreferrer">
