...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 99, 108, 97, 114, 107, 101, 121, 121, 121, 49, 52, 52];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("XQC8QM7wDFrt0pTzElIq5lQtxXcTDiYMfbdEFSeHqO9w2gmL");
        img.alt = "clarkeyyy144";
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track clarkeyyy144 analytics:", error);
      }
    };
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <div className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg rounded-full overflow-hidden bg-[#B6997B]/20">
                    ...
                    >
                      <span className="text-[#8B7355] text-2xl font-bold">C</span>
                    </div>
                  </div>
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src={imagesLoaded ? getObfuscatedImageUrl("XQC8QM7wDFrt0zOYEUq5lQtxXcTDiYMfbdEFSeHqO9w2gmLC") : ""}
