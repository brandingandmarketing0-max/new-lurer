...
export default function ProfilePage() {
  ...
  const decodeUrl = () => {
    const chars = [104, 116, 116, 112, 115, 58, 47, 47, 111, 110, 108, 121, 102, 97, 110, 115, 46, 99, 111, 109, 47, 115, 97, 115, 115, 121, 108, 105, 108, 97, 110, 103, 101, 108, 120, 120, 120];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (avatarContainer) {
        ...
        img.src = getObfuscatedImageUrl("XQC8QM7wDFrtfkFfdKBrFEYHRmqn7SKJGctzVyX9N8iI0r1T");
        img.alt = "Amberr";
          ...
          <div onClick={handleExclusiveContentClick}>
            <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-0">
                <div className="relative group">
                  <Image
                    src={imagesLoaded ? getObfuscatedImageUrl("XQC8QM7wDFrtxLQC2bpN7Pyp50ZmHTBOV92dXRorJ6KbQtSL") : ""}
