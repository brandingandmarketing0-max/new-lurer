...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/laurdunne-analytics", {
      ...
      console.error("Failed to track Laurdunne analytics:", error);
    });
  }, []);
  ...
  const trackClick = async (clickType: string) => {
    try {
      await fetch("/api/laurdunne-analytics", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          page: "laurdunne",
      ...
      <div className="flex min-h-screen items-center justify-center px-2">
        <div className="w-full max-w-md mx-auto">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="/images/laur1.png" alt="Summermae" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Link href="https://onlyfans.com/laurdunne" target="_blank" rel="noopener noreferrer">
