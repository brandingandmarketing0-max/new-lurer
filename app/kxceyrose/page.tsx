  ...
  useEffect(() => {
    ...
    const send = () => {
      try {
        ...
        console.error("Failed to track Kxceyrose analytics:", error);
      }
    };
      ...
      <div className="flex min-h-screen items-center justify-center px-2">
        <div className="w-full max-w-md mx-auto">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtbkHoB9Gw5PsTJ23NUOtXn7myKL9CSZ6l0aru" alt="Summermae" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Link href="https://onlyfans.com/kxceyrose" target="_blank" rel="noopener noreferrer">
              <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtDondCzgCyXzMPYSn748thW9IkZK6iLFeTRfQ"
