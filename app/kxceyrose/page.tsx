...
export default function ProfilePage() {
  ...
  const trackClick = async (clickType: string) => {
    try {
      await fetch("/api/kxceyrose-analytics", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          page: "kxceyrose",
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="/images/kxceyrose1.png" alt="Summermae" className="object-cover" />
