...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const sessionId = `megann_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
    const sessionKey = `megann_visit_tracked_${sessionId}`;
    ...
    const send = () => {
      try {
        ...
        if (navigator.sendBeacon) {
          ...
          console.log("✅ Megann Analytics - Page visit tracked via sendBeacon");
          
          // Mark this specific session as tracked
          localStorage.setItem(sessionKey, 'true');
          localStorage.setItem('megann_last_tracked', new Date().toISOString());
          setHasTracked(true);
        } else {
          fetch("/api/track", {
            method: "POST",
            ...
            console.log("✅ Megann Analytics - Page visit tracked via fetch");
            ...
            console.error("❌ Megann Analytics - Page visit tracking failed:", error);
          });
        }
      } catch (error) {
        console.error("❌ Failed to track Megann analytics:", error);
      }
    };
      ...
      <div className="flex min-h-screen items-center justify-center px-2">
        <div className="w-full max-w-md mx-auto">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="relative h-28 w-28 border-4 border-[#B6997B]/20 shadow-lg">
                    <AvatarImage src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtc5XV4lITW4mI0AxkbMGZ3ViDPvE5npKtzd2N" alt="Summermae" className="object-cover" />
          ...
          <div onClick={handleExclusiveContentClick}>
            <Link href="http://onlyfans.com/lilmegs_x" target="_blank" rel="noopener noreferrer">
              <Card className="mt-6 relative overflow-hidden border border-[#B6997B]/50 bg-[#B6997B]/10 shadow-lg backdrop-blur-sm cursor-pointer hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative group">
                    <Image
                      src="https://2eovi9l2gc.ufs.sh/f/XQC8QM7wDFrtz5gebs9qCSay35uLTDJ0d4jn8xMZUczPtBrR"
          ...
          <div className="mt-6 space-y-4">
            <div onClick={handleSubscribeClick}>
              <Link href="https://onlyfans.com/lilmegs_x" target="_blank" rel="noopener noreferrer">
